...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            // Seeding table Department
            Department d1 = new Department(1, "Computer");
            Department d2 = new Department(2, "Electronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            // Seeding table Seller
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex_g@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            ...
            // Add the objects above at the database 

            _context.Department.AddRange(d1, d2, d3, d4);                           // Adding the departments

            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);                       // adding the sellers

            _context.SalesRecord.AddRange(r1, r2, r3, r4, r5, r6, r7, r8, r9,       // adding the sales record
